...
/*
    ...
    OBSERVERA att idag använder vi bara metoder för att lägga till lyssnare...
*/
...
window.addEventListener('load', function() {
    ...
    formRef.addEventListener('reset', function() {
    ...
    document.querySelector('#txtFritext').addEventListener('input', function(e) {

        document.querySelector('#nbrOfChars').textContent = e.target.value.length;
    ...
    document.querySelector('#container').addEventListener('click', function(e) {
        ...
        if(e.target.nodeName === 'P' && e.target.textContent.length === 1) {
